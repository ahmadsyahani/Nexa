class AppTranslations {
  static Map<String, Map<String, String>> data = {
    'id': {
      ...
      'menu_rekap': 'Presensi MIS',
      'rekap_title': 'Rekap Presensi',
      'rekap_subtitle': 'Rekap Kehadiran Kuliah Online-MIS',
      'rekap_hadir': 'Hadir',
      'rekap_alpha': 'Tidak Hadir',
      'rekap_upcoming': 'Belum Ada Data',
      'rekap_total_matkul': 'Mata Kuliah',
      'rekap_avg_attendance': 'Rata-rata Kehadiran',
      'rekap_search_placeholder': 'Cari mata kuliah...',
      'rekap_empty': 'Belum ada data presensi perkuliahan.',
      'rekap_week': 'Mg',
      'rekap_safe': 'Aman',
      'rekap_warning': 'Waspada',
      'rekap_danger': 'Bahaya',
      'pomodoro_work': 'Fokus',
    ...
    'en': {
      ...
      'menu_rekap': 'Attendance',
      'rekap_title': 'Attendance Recap',
      'rekap_subtitle': 'Online-MIS Attendance Status',
      'rekap_hadir': 'Present',
      'rekap_alpha': 'Absent',
      'rekap_upcoming': 'No Data',
      'rekap_total_matkul': 'Courses',
      'rekap_avg_attendance': 'Avg Attendance',
      'rekap_search_placeholder': 'Search courses...',
      'rekap_empty': 'No attendance data available.',
      'rekap_week': 'Wk',
      'rekap_safe': 'Safe',
      'rekap_warning': 'Warning',
      'rekap_danger': 'Critical',
      'pomodoro_work': 'Focus',
